...
import GlassCheckoutCard from "../components/community/GlassCheckoutCard";
...
const Checkout = () => {
  ...
  const total = subtotal ? subtotal + 5 + subtotal / 5 : 0;
  const { t } = useLanguage();
  ...
  return (
    <div className="mx-auto max-w-screen-2xl">
      <div className="pb-24 pt-16 px-5 max-[400px]:px-3">
        <h2 className="sr-only">{t("payment")}</h2>
        ...
        >
          <div>
            ...
            <div className="mt-10 border-t border-gray-200 pt-10">
              <GlassCheckoutCard amount={total} />
            </div>
          </div>
          ...
          <div className="mt-10 lg:mt-0">
            ...
            <div className="mt-4 border border-gray-200 bg-white shadow-sm">
              <h3 className="sr-only">{t("cartItems")}</h3>
              ...
              <dl className="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div className="flex items-center justify-between">
                  <dt className="text-sm">{t("taxes")}</dt>
                  <dd className="text-sm font-medium text-gray-900">
              ...
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                <Button text={t("confirmOrder")} mode="brown" />
              </div>
            </div>
          </div>
        </form>
