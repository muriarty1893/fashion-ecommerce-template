...
const ShopFilterAndSort = ({
  ...
  return (
    <section className="px-5 max-[400px]:px-3">
      <div className="flex items-center justify-between gap-4 max-sm:flex-col max-sm:items-start">
        <p className="text-lg">
          {t("showing")} {showingProducts === 0 ? 0 : 1}-{showingProducts} {t("of")} {totalProducts} {t("productsShown")}
        </p>
      ...
      <div className="mt-5 grid gap-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm sm:grid-cols-2 lg:grid-cols-6">
        ...
        <div className="flex items-end">
          <button
            ...
            className="h-10 w-full rounded border border-gray-300 px-3 text-sm font-medium text-gray-700 transition hover:border-gray-950 hover:text-gray-950"
          >
            Reset
          </button>
        </div>
