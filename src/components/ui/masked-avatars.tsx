                    ...
                    ${(size - column) * 0.5}px
                            ...
                            >
                                ...
                                <div className="avatar-holder absolute inset-0 grid content-end">
                                    <motion.span
                                        className={cn(
                                            "avatar inline-block w-full aspect-square rounded-full relative overflow-hidden pointer-events-auto border-[3px] border-oklch(1 0 0) will-change-transform dark:border-oklch(0.147 0.004 49.25)",
                                            "focus:ring-2 focus:ring-offset-2 focus:ring-oklch(0.147 0.004 49.25) dark:focus:ring-oklch(0.985 0.001 106.423)"
                                        )}
                                        role="img"
                                        ...
                                        animate={{
                                            maskPosition: index === 0 ? "0" : maskPosition,
                                    ...
                                    >
                                        <img
                                            src={person.avatar}
                                            alt={person.name}
                                            className="absolute inset-0 w-full h-full object-cover bg-oklch(0.97 0.001 106.424) dark:bg-oklch(0.268 0.007 34.298)"
                                        />
                                    </motion.span>
                                </div>
